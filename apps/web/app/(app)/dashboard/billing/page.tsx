...
import { PLANS, PLAN_ORDER, type PlanCode } from "@getpostflow/billing";
import { getBillingInfo, cancelSubscription } from "./actions";
...
export default function BillingPage() {
  ...
  const currentPlanCode = (billingInfo?.subscription?.planCode as PlanCode) ?? "starter";
  ...
  const currentPlan = PLANS[currentPlanCode];
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-sm mt-1" style={{ color: "var(--text-secondary)" }}>
                {currentPlan?.monthlyDisplay}/month
              </p>
